...
(cl:in-package srv_func_package-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <add_int-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'add_int-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name srv_func_package-srv:<add_int-request> is deprecated: use srv_func_package-srv:add_int-request instead.")))

(cl:ensure-generic-function 'num1-val :lambda-list '(m))
(cl:defmethod num1-val ((m <add_int-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader srv_func_package-srv:num1-val is deprecated.  Use srv_func_package-srv:num1 instead.")
  (num1 m))

(cl:ensure-generic-function 'num2-val :lambda-list '(m))
(cl:defmethod num2-val ((m <add_int-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader srv_func_package-srv:num2-val is deprecated.  Use srv_func_package-srv:num2 instead.")
  (num2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<add_int-request>)))
  ...
  "srv_func_package/add_intRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'add_int-request)))
  "Returns string type for a service object of type 'add_int-request"
  "srv_func_package/add_intRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <add_int-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'add_int-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name srv_func_package-srv:<add_int-response> is deprecated: use srv_func_package-srv:add_int-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <add_int-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader srv_func_package-srv:sum-val is deprecated.  Use srv_func_package-srv:sum instead.")
  (sum m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<add_int-response>)))
  ...
  "srv_func_package/add_intResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'add_int-response)))
  "Returns string type for a service object of type 'add_int-response"
  "srv_func_package/add_intResponse")
